...
class SystemPage(models.Model):
    ...
    url_name = models.CharField(max_length=100, unique=True, verbose_name="الاسم البرمجي للرابط")
    icon_name = models.CharField(max_length=100, blank=True, null=True, verbose_name="اسم أيقونة Lucide")
...
class Subscription(models.Model):
    ...
    serial_number = models.CharField(max_length=36, unique=True, editable=False, verbose_name="السيريال")
    start_date = models.DateField(null=True, blank=True, verbose_name="تاريخ بداية التفعيل")
    end_date = models.DateField(null=True, blank=True, verbose_name="تاريخ نهاية الاشتراك")
    is_active = models.BooleanField(default=False, verbose_name="الاشتراك فعال")
    class Meta:
        verbose_name = "اشتراك"
